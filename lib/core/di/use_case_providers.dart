...
import '../../domain/usecases/add_price_record_usecase.dart';
...
final addPriceRecordUseCaseProvider = Provider<AddPriceRecordUseCase>((ref) {
  final priceRepository = ref.watch(priceRepositoryProvider);
  return AddPriceRecordUseCase(priceRepository);
});
